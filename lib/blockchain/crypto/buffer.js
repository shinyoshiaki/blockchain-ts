 ...
 *
 */
const browserify_bignum_1 = __importDefault(require("browserify-bignum"));
exports.bigNumberToBuffer = (bignumber, size) => new browserify_bignum_1.default(bignumber).toBuffer({ size, endian: 'big' });
exports.bufferToBigNumberString = (bigNumberBuffer) => browserify_bignum_1.default.fromBuffer(bigNumberBuffer).toString();
